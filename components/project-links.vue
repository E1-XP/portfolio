<template>
  <ol class="project-links">
    <li v-if="project.webpage" class="project-links__item project-links__item--scaled">
      <a :href="project.webpage" class="project-links__link">
    ...
    <li class="project-links__item">
      <a :href="project.url" class="project-links__link">
        <span class="project-links__icon">
