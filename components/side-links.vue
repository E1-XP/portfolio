<template>
  <aside class="side-links" :class="{'h-hidden-on-mobile': $nuxt.$route.path !== '/'}">
    <ul class="side-links__list">
      ...
      <li class="side-links__item">
        <a
          href="https://stackoverflow.com/users/8520336/e1-xp?tab=profile"
          class="side-links__link"
        >
          <span class="side-links__icon">
            <svg width="29" height="27" viewBox="0 0 29 27" fill="none">
              <path
                d="M21.837 23.112H6.11899V16.848H3.88599V25.191H24.041V16.848H21.837V23.112Z"
                fill="white"
              />
              <path
                d="M18.4272 1.81165L16.6339 3.05032L23.3032 11.4202L25.0966 10.1816L18.4272 1.81165Z"
                fill="white"
              />
              <path
                d="M14.2889 5.15588L12.8611 6.75443L21.4681 13.4183L22.8959 11.8197L14.2889 5.15588Z"
                fill="white"
              />
              <path d="M19.575 18.927H8.38098V21.006H19.575V18.927Z" fill="white" />
              <path
                d="M21.141 13.905L10.991 9.47699L10.034 11.394L20.184 15.795L21.141 13.905Z"
                fill="white"
              />
              <path
                d="M20.039 16.335L9.07698 14.202L8.58398 16.254L19.546 18.387L20.039 16.335Z"
                fill="white"
              />
            </svg>
          </span>
      ...
      <li class="side-links__item">
        <a href="https://www.codewars.com/users/E1XP" class="side-links__link">
          <span class="side-links__icon">
